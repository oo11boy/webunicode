...
export default function SlideCard({items}) {
    ...
    return (
        <div className="w-full shadow-md my-10 slidecard  relative bg-white rounded-xl overflow-hidden h-[540px]">
            <img
            ...
            <a
                ...
                href="#"
                className="w-[90%] portfolio-slide-title flex bg-[#1D2027] h-20 absolute skew-x-12 right-[-5%] top-[40%]"
            >
                <div className="skew-x-11 icontitletext flex w-[40%] bg-red-700 justify-center items-center h-full">
                    <span className={`${items.icon} text-4xl -skew-x-12 text-white pr-4`}></span>
                </div>
                <div className="flex justify-center items-center -skew-x-12 pr-4 text-xl">
                    <div href="#" className="text-white titletext">{items.title}</div>
                </div>
            </a>
