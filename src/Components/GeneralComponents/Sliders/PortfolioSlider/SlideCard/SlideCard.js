    ...
    return (
        <div className="w-full slidecard relative bg-white rounded-xl overflow-hidden h-[540px]">
            ...
            <a
                ...
                href="#"
                className="w-[90%] flex bg-[#1D2027] h-20 absolute skew-x-12 right-[-5%] top-[42%]"
            >
                <div className="skew-x-11 flex w-[40%] bg-red-700 justify-center items-center h-full">
                ...
                <div className="flex justify-center items-center -skew-x-12 pr-4 text-xl">
                    <div href="#" className="text-white">شرکتی مهندسی</div>
                </div>
            </a>
