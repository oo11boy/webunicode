  ...
  return (
    <div className="relative mainimgwhyus w-full lg:w-[43%] lg:pr-[7%] md:h-[450px]">
      <img
        ...
        alt={`تصویر اصلی ${DynamicWhyUs.title}`}
        loading="lazy"
      />
      <div
        className="p-6 hidden md:flex py-24 w-[180px] h-[180px] justify-center items-center flex-col text-4xl text-white absolute bottom-10 rounded-xl right-0 whyusgradiant border border-gray-200"
        aria-hidden="true"
      >
