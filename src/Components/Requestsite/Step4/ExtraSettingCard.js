...
export default function ExtraSettingCard({domainNeeded,setDomainNeeded,extraHosting,setExtraHosting,companyOptions,storeOptions,serviceOptions,infoorder,setSelection,Selection}) {
  return (
