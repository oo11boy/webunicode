export const PortfolioDb = [
    {
        ...
        icon: "icon-cart",
        content: "قالب دیجیکالا برای طراحی فروشگاه‌های آنلاین با ویژگی‌های پیشرفته مناسب است."
    },
    {
        id: 2,
        ...
        icon: "icon-cart",
        content: "این قالب برای فروشگاه‌های محصولات زیبایی و آرایشی طراحی شده است."
    },
    {
        id: 3,
        name: " فروشگاه فایل",
        ...
        icon: "icon-cart",
        content: "قالب فروشگاه فایل برای فروش و مدیریت اسناد و فایل‌ها ایده‌آل است."
    },
    {
        id: 4,
        name: "فروش جواهرات",
        ...
        icon: "icon-cart",
        content: "برای فروشگاه‌های جواهرات و زیورآلات، این قالب طراحی شده است."
    },
    {
        id: 5,
        name: "شیک پوش",
    ...
    },
    {
        ...
        icon: "icon-cart",
        content: "این قالب برای فروشگاه‌های عسل و محصولات طبیعی طراحی شده است."
    },
    {
        id: 7,
        name: "لوازم آرایشی",
        ...
        icon: "icon-cart",
        content: "قالب لوازم آرایشی برای فروشگاه‌های محصولات زیبایی طراحی شده است."
    },
    {
        id: 8,
        name: "فروشگاه ساعت",
        ...
        icon: "icon-cart",
        content: "برای فروشگاه‌های ساعت و جواهرات این قالب مناسب است."
    },
    {
        id: 9,
        ...
        icon: "icon-cart",
        content: "این قالب برای فروشگاه‌های لامپ و روشنایی مناسب است."
    },
    {
        id: 10,
        ...
        icon: "icon-cart",
        content: "برای فروشگاه‌های سخت افزار و ابزار، این قالب طراحی شده است."
    },
    {
        id: 11,
        ...
        icon: "icon-cart",
        content: "قالب موبایل و لوازم جانبی برای فروشگاه‌های تکنولوژی مناسب است."
    },
    {
        id: 12,
        name: " عطر و ادکلن",
        ...
        icon: "icon-cart",
        content: "این قالب برای فروشگاه‌های عطر و ادکلن طراحی شده است."
    },
    {
        id: 13,
        name: "فروشگاه بازی",
        ...
        icon: "icon-cart",
        content: "برای فروشگاه‌های بازی و سرگرمی، این قالب طراحی شده است."
    },
    {
        id: 14,
        name: "فروشگاه لباس",
        ...
        icon: "icon-cart",
        content: "قالب فروشگاه لباس با طراحی زیبا و کاربردی."
    },
    {
        id: 15,
        ...
        icon: "icon-cart",
        content: "برای فروشگاه‌های دوره‌های آموزشی و آنلاین مناسب است."
    },
    {
        id: 16,
        name: "فروش گل و گیاه",
        ...
        icon: "icon-cart",
        content: "قالب فروشگاه گل و گیاه برای فروشگاه‌های مرتبط با گیاهان و گل‌ها."
    },
    {
        id: 17,
        ...
        icon: "icon-cart",
        content: "برای فروشگاه‌های جواهرات و زیورآلات گلدشاپ طراحی شده است."
    },
    {
        id: 18,
        name: " قالب شرکتی 1",
        ...
        icon: "icon-office",
        content: "قالب شرکتی با طراحی مدرن و حرفه‌ای برای کسب‌وکارها."
    },
    {
        id: 19,
        name: " قالب شرکتی 2",
